        ...
        case 'makeImport'
            ...
            if ~isempty(functionname) && ~isempty(outputdir)
                ...
                fprintf(fid, ['# Function: %s\n' ...
                        ...
                        'data_dir = "%s"\n' ...
                        'data_type =  "%s"\n' ...
                        'df.%s <- dir(path=data_dir, pattern = data_type, full.names=TRUE) %>%\n' ...
                        'map(%s) %>% reduce(rbind)\n\n'], functionname, ...
                        timestamp, functionname, analysis_dir, import_code, functionname, import_fcn);
