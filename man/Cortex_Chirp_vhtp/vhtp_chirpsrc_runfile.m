...
% Dependencies
restoredefaultpath; % clear all MATLAB paths
vhtp_path = '/srv/vhtp';
...
parfor fi = 1 : height(myFileListSource)
    ...
    EEG = pop_select(EEG, 'channel', {'medialorbitofrontalL'})
    [EEG2, results] = eeg_htpCalcChirpItcErsp(EEG, ...
        'sourceOn', true, ...
        'byChannel', true, ...
        'baselinew', [-500 0]);
    EEGCell{fi} = EEG2;  
