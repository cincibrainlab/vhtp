...
% Save large collection of PreRun Data
save(fullfile(myDatasetOuput, 'chirpCell.mat'), 'EEGCell', '-v7.3')
%%
...
[EEGchirp2, results] = eeg_htpVisualizeChirpItcErsp( EEGCell, 'groupmean', true, 'singleplot', true, ...
    'groupIds', sorted_eegidgroup_table.subgroup,'outputdir',fullfile(myDatasetOuput, 'sourcetracings_region_sex'), ...
    'averageByRegion', true, 'contrasts', {[1 3],[2 4]});

[EEGchirp2, results] = eeg_htpVisualizeChirpItcErsp( EEGCell, 'groupmean', true, 'singleplot', true, ...
    'groupIds', sorted_eegidgroup_table.group,'outputdir',fullfile(myDatasetOuput, 'sourcetracings_region_group'), ...
