...
% user defined paths
% se_dir          = 'TBD';
% braph_dir       = 'C:\Users\Rui Liu\Documents\MATLAB\BRAPH-master';
% bct_dir         = 'C:\Users\Rui Liu\Documents\MATLAB\BCT';
...
for i = 1 : number_of_input_files
    ...
    [~, results] = eeg_htpGraphPhaseBcm1(EEG1, 'gpuOn', true, 'outputdir', results_dir, ...
        'bandDefs', {'delta', 2, 3.5; 'theta', 4, 6; 'alpha', 6.5, 10; ...
        %'alpha1', 8, 10; 'alpha2', 10.5, 12.5; ...
        'beta', 10.5, 14.5; %'gamma', 30, 55;      % original in the poster, faster to process
        }, 'useParquet', false);
%     [~, results] = eeg_htpGraphPhaseBcm(EEG1, 'gpuOn', true, 'outputdir', results_dir, ...
%         'bandDefs', {'delta', 2, 3.5; 'theta', 4, 7.5;  ...
%         'alpha1', 8, 10; 'alpha2', 10.5, 12.5; ...
%         'beta', 13, 30; 'gamma', 30, 55 }, 'useParquet', false); % 06/21/2023 test
   
%     [EEG, results] = eeg_htpGraphPhaseBcm(EEG, 'gpuOn', true, 'duration', 60, 'offset', 0, 'window', 2, 'outputdir', results_dir, ...
%         'bandDefs', {'delta (2-3Hz)', 2, 3.5; 'theta', 4, 6; 'alpha', 6.5, 10; 'beta', 10.5, 14.5;}, 'useParquet', false)
