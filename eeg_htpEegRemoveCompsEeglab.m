...
if isfield(EEG,'vhtp') && isfield(EEG.vhtp,'inforow') && isfield(EEG.vhtp.eeg_htpEegRemoveCompsEeglab,'proc_removeComps') && ~isempty(EEG.vhtp.eeg_htpEegRemoveCompsEeglab.proc_removeComps)
